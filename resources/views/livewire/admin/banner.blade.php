                    ...
                    <div class="bg-white px-6 pt-6 pb-4 sm:p-8">
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                <label for="start_date" class="block text-sm font-semibold text-gray-700 mb-1">Mulai
                                    Tayang</label>
                            ...
                            <div class="sm:col-span-3">
                                <label for="end_date" class="block text-sm font-semibold text-gray-700 mb-1">Selesai
                                    Tayang</label>
                            ...
                            <!-- Priority & Checkbox -->
                            <div class="sm:col-span-3">
                                <label for="priority" class="block text-sm font-semibold text-gray-700 mb-1">Urutan
                                    Prioritas</label>
                            ...
                            <div class="sm:col-span-6">
                                <label for="description"
                                    class="block text-sm font-semibold text-gray-700 mb-1">Deskripsi (Opsional)</label>
                                <div wire:ignore
