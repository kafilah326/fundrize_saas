                        ...
                        <tr class="hover:bg-orange-50/30 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center text-sm text-gray-900">
                                    ...
                                    <span class="font-mono text-xs bg-gray-100 px-2 py-1 rounded">{{ $category->icon ?? '-' }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <button wire:click="edit({{ $category->id }})" class="text-indigo-600 hover:text-indigo-900 mr-3 transition-colors duration-200">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </button>
                                <button wire:click="confirmDelete({{ $category->id }})" class="text-red-600 hover:text-red-900 transition-colors duration-200">
                            ...
                            <div class="mt-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="text" wire:model.live="icon" id="icon" class="flex-1 min-w-0 block w-full px-4 py-2.5 rounded-none rounded-l-xl focus:ring-primary focus:border-primary text-base border-gray-300 bg-gray-50 focus:bg-white transition-colors" placeholder="fa-solid fa-tag">
