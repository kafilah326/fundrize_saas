<div>
    ...
    @section('header', 'Daftar Kategori Program')
                        ...
                        <tr class="hover:bg-orange-50/30 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center text-sm text-gray-900">
                                    ...
                                    <span
                                        class="font-mono text-xs bg-gray-100 px-2 py-1 rounded">{{ $category->icon ?? '-' }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-10 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Silakan tambahkan kategori baru.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
                            ...
                            <div class="mt-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="slug" id="slug"
                                        class="mt-1 block w-full border border-gray-300 rounded-xl shadow-sm py-2.5 px-4 focus:outline-none focus:ring-primary focus:border-primary text-base bg-gray-100 cursor-not-allowed"
                                        readonly>
                                    @error('slug')
                                        <span class="text-red-500 text-xs">{{ $message }}</span>
                                    @enderror
                                ...
                                <div>
                                    <label for="icon" class="block text-sm font-medium text-gray-700">
                                        ...
                                        <a href="https://fontawesome.com/icons" target="_blank"
                                            class="text-xs text-blue-500 hover:underline ml-1">(Lihat Icon)</a>
                                    </label>
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="text" wire:model.live="icon" id="icon"
                                            class="flex-1 min-w-0 block w-full px-4 py-2.5 rounded-none rounded-l-xl focus:ring-primary focus:border-primary text-base border-gray-300 bg-gray-50 focus:bg-white transition-colors"
                                            placeholder="fa-solid fa-tag">
                                        <span
                                            class="inline-flex items-center px-4 rounded-r-xl border border-l-0 border-gray-300 bg-gray-50 text-gray-500 text-base">
