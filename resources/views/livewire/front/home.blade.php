    ...
    <header id="header" class="bg-white shadow-sm sticky top-0 z-50">
        <div class="px-4 py-3 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <img src="{{ $foundation->logo }}" alt="Logo" class="h-16 w-auto object-contain">
            </div>
    ...
    <main id="main-content" class="pb-20">
                    ...
                    <div class="min-w-full">
                        <div class="relative aspect-video overflow-hidden rounded-2xl">
                            ...
                            <div class="absolute bottom-0 left-0 right-0 p-4">
                                ...
                                @if($banner->link_url)
                                    <a href="{{ $banner->link_url }}" class="bg-primary text-white px-5 py-2 rounded-full text-xs font-semibold inline-block">
        ...
        <section id="akad-section" class="bg-white px-4 py-5 mt-2">
            ...
            <div class="grid grid-cols-4 gap-3">
                ...
                <a href="{{ route('program.index', ['akad' => $akad->slug]) }}" wire:navigate class="flex flex-col items-center gap-2">
        ...
        <section id="featured-programs" class="bg-white px-4 py-5 mt-2">
            ...
            <div class="flex gap-3 overflow-x-auto hide-scrollbar pb-2">
                ...
                <a href="{{ route('program.detail', $program->slug) }}" wire:navigate class="min-w-[260px] bg-white rounded-2xl shadow-sm border border-gray-100 block">
                    ...
                    <div class="p-3">
                        <h4 class="font-semibold text-sm text-dark mb-2 line-clamp-2">{{ $program->title }}</h4>
                        ...
                        @else
                        <div class="flex items-center gap-1 mt-2 mb-1 text-primary">
                            <i class="fa-solid fa-infinity text-sm"></i>
                            <span class="text-xs font-bold">Unlimited</span>
                        </div>
                        <p class="text-xs text-gray-500">Donasi Terkumpul</p>
                        @endif
                    </div>
        ...
        <section id="program-menu" class="bg-white px-4 py-5 mt-2">
            ...
            <div class="grid grid-cols-4 gap-3">
                ...
                <a href="{{ route('program.index', ['category' => $category->slug]) }}" wire:navigate class="flex flex-col items-center gap-2">
                    ...
                    <span class="text-xs font-medium text-gray-600 text-center leading-tight">{{ $category->name }}</span>
                </a>
                @endforeach
            </div>
        </section>
        ...
        <section id="about-foundation" class="bg-white px-4 py-5 mt-2 mb-20">
            ...
            <p class="text-xs text-gray-600 leading-relaxed mb-3 line-clamp-3">{{ Str::limit(strip_tags($foundation->about), 200) }}</p>
            <a href="{{ route('foundation.profile') }}" wire:navigate class="w-full bg-primary text-white py-3 rounded-xl text-sm font-semibold block text-center">Lihat Selengkapnya</a>
        </section>
    </main>
